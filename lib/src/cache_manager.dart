...
import 'cache_managers/base_cache_manager.dart';
import 'cache_store.dart';
import 'config/config.dart';
import 'logger.dart';
import 'result/download_progress.dart';
...
class CacheManager implements BaseCacheManager {
  ...
  Future<FileInfo> downloadFile(
    ...
    final fileResponse = await _webHelper
        .downloadFile(url, key: key, authHeaders: authHeaders, ignoreMemCache: force)
  ...
  Future<File> putFile(
    ...
    cacheObject = cacheObject.copyWith(validTill: DateTime.now().add(maxAge), eTag: eTag);
