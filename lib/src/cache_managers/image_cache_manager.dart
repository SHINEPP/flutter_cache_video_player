...
mixin ImageCacheManager on BaseCacheManager {
  ...
  Future<FileInfo> _resizeImageFile(
    ...
    final resized = await _decodeImage(originalFile.file, width: maxWidth, height: maxHeight);
    ...
    return FileInfo(file, originalFile.source, originalFile.validTill, originalFile.originalUrl);
  }
